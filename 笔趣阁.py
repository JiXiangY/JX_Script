...
import sys
req_header={
"Cookie": "Hm_lpvt_6dfe3c8f195b43b8e667a2a2e5936122=1590035226; Hm_lpvt_c979821d0eeb958aa7201d31a6991f34=1590035226; Hm_lvt_6dfe3c8f195b43b8e667a2a2e5936122=1590035226; Hm_lvt_c979821d0eeb958aa7201d31a6991f34=1590035212; clickbids=12696",
...
req_url_base='http://www.biquge.info/'           #小说主地址
...
def get_txt(txt_id):
    ...
    try:
        ...
        print("正在寻找第一章页面。。。")
        #获取小说所有章节信息
        temp_list = soups.select('#wrapper .box_con #list dl dd a')
        section_list = temp_list[560+22:]
        #获取小说总章页面数
        section_ct=len(section_list)
        #获取小说第一章页面地址
        first_page = section_list[0]['href']
        ...
        while i < section_ct:
            try:
                section_num = section_list[i]
                section_url = req_url + section_num['href']
                #请求当前章节页面
                r=requests.get(section_url, params=req_header)
                #新笔趣阁的编码格式为gbk
                r.encoding = 'gzip'
                #soup转换
